...
rownames(xe1_spe) <- rowData(xe1_spe)$Symbol
...
repath <- here::here(file.path("raw_rds", "Janesick_breastCancer_Xenium_rep1"))
dir.create(repath, showWarnings=FALSE, recursive=TRUE)
saveRDS(xe1_spe, file=file.path(repath, "Janesick_breastCancer_Xenium_rep1.rds"))
